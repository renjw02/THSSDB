...
public interface SQLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLParser#beginStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBeginStmt(SQLParser.BeginStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLParser#savepointName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSavepointName(SQLParser.SavepointNameContext ctx);
	/**
