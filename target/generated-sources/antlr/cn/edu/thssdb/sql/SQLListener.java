...
public interface SQLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SQLParser#beginStmt}.
	 * @param ctx the parse tree
	 */
	void enterBeginStmt(SQLParser.BeginStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLParser#beginStmt}.
	 * @param ctx the parse tree
	 */
	void exitBeginStmt(SQLParser.BeginStmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SQLParser#savepointName}.
	 * @param ctx the parse tree
	 */
	void enterSavepointName(SQLParser.SavepointNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLParser#savepointName}.
	 * @param ctx the parse tree
	 */
	void exitSavepointName(SQLParser.SavepointNameContext ctx);
	/**
