...
public class ConditionToken {
  ...
  public ComparerToken expr1;
  public ComparerToken expr2;

  public ConditionToken(ComparerToken expr1, ComparerToken expr2, String op) {
    this.comparator = op;
    this.expr1 = expr1;
    this.expr2 = expr2;
  }

  public ComparerToken getChild(int i) {
    if (i == 0) {
      return this.expr1;
    } else if (i == 1) {
      return this.expr2;
  ...
  public Boolean evaluate(Row row, ArrayList<String> columnName) {
    try {
      ...
      // if(value1!=null){System.out.println("value1 = " + value1.getClass().toString() + " " +
      // value1);}
      expr2.Calculate(row, columnName);
      Object value2 = expr2.getValue(row, columnName);
      // if(value2!=null){System.out.println("value2 = " + value2.getClass().toString() + " " +
      // value2);}
      ...
      throw new TypeNotMatchException(expr1.getType(), expr2.getType());
    }
  }
}
