...
public class Client {
  ...
  public static IService.Client client;
  ...
  public static void testStatement(String statement) {
    execute(statement);
  }
  ...
  public static void testConnect(String username, String password) {
  ...
  private static void showHelp() {
    // TODO
    println("----------------------");
    println("connect root root;");
    println("create database databaseName;");
    println("show databases;");
    println("use db1;");
    println("drop database db1;");
    println("create table t1 ( c1 int primary key );");
    println("show table t1;");
    println("insert into t1 ( C1 ) values ( 1 );");
    println("create user user1 identified by 'password'");
    println("connect user1 'password';");
    println("connect root root;");
    println("----------------------");
  }
